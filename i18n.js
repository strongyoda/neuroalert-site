...
const I18N = {
  en: {
    ...
    js_variant:"variants", js_event_note:"Adverse-event reports (not recalls)", js_detail_hint:"details",
  ...
  ko: {
    ...
    js_variant:"변형", js_event_note:"이상사례 신고 (회수 아님)", js_detail_hint:"상세 보기",
