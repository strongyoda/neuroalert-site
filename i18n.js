...
const I18N = {
  en: {
    ...
    src_jp:"PMDA — Device Recalls", cov_jp:"Device recalls with product, manufacturer, reason, and date (translated from Japanese).",
  ...
  ko: {
    ...
    src_jp:"PMDA — 의료기기 회수", cov_jp:"제품·제조사·사유·날짜 포함 (일본어에서 번역).",
    sub_title:"이메일 알림",
