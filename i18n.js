...
const I18N = {
  ...
  ko: {
    ...
    src_jp:"PMDA — 의료기기 회수", cov_jp:"제품·제조사·사유·날짜 포함 (일본어에서 번역).", src_de:"BfArM — 의료기기 안전성 공지", src_uk:"MHRA — 현장 안전성 공지", cov_de:"제조사 안전성 공지 (독일어에서 번역); 사유는 공식 PDF에서 추출.", cov_uk:"제조사·기기·사유·조치 포함 현장안전성 공지 (FSN PDF에서).",
    sub_title:"이메일 알림",
