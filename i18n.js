...
const I18N = {
  en: {
    ...
    ev_device_problem:"Device problem", ev_patient_problem:"Patient problem", ev_narrative:"Event narrative (FDA MAUDE, original)", ev_mfr_narrative:"Manufacturer analysis (original)", ev_type_label:"Event type:", ev_report_label:"Report No.", ev_fda_link:"openFDA source data →",
  ...
  ko: {
    ...
    ev_device_problem:"기기 문제", ev_patient_problem:"환자 문제", ev_narrative:"사건 경위 (FDA MAUDE 원문)", ev_mfr_narrative:"제조사 분석 (원문)", ev_type_label:"사건 유형:", ev_report_label:"리포트번호", ev_fda_link:"openFDA 원본 데이터 →",
