...
const I18N = {
  en: {
    ...
    hero_sub:"Consolidated recall and adverse-event signals for neurointerventional devices — drawn from the U.S. FDA, Korea MFDS, Australia TGA, Health Canada, Germany BfArM, and UK MHRA public post-market databases.",
  ...
  ko: {
    ...
    hero_sub:"신경중재 의료기기의 리콜·이상사례 신호를 미국 FDA, 한국 식약처(MFDS), 호주 TGA, 캐나다 보건부, 독일 BfArM, 영국 MHRA의 공개 사후감시 데이터에서 모아 한 화면에 보여줍니다.",
