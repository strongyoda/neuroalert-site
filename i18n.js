...
const I18N = {
  en: {
    ...
    hero_sub:"Consolidated recall and adverse-event signals for neurointerventional devices — drawn from the U.S. FDA, Korea MFDS, and Australia TGA public post-market databases.",
    ...
    alert_scope:"Alerts cover <strong>US, Korea &amp; Australia</strong> device recalls.",
    ...
    src_us:"FDA openFDA — Recall & Event", src_kr:"MFDS — Medical Device Recall", src_au:"TGA DRAC — Device Recalls",
  ...
  ko: {
    ...
    hero_sub:"신경중재 의료기기의 리콜·이상사례 신호를 미국 FDA, 한국 식약처(MFDS), 호주 TGA의 공개 사후감시 데이터에서 모아 한 화면에 보여줍니다.",
    ...
    alert_scope:"알림은 <strong>미국·한국·호주</strong> 의료기기 리콜을 발송합니다.",
    sub_fine:'입력하신 이메일은 알림 발송에만 사용되며, 구독 해지 시 즉시 완전히 삭제됩니다. <a href="privacy.html">개인정보처리방침</a>을 참고하세요.',
    src_title:"데이터 출처",
    src_us:"FDA openFDA — 리콜·이상사례", src_kr:"식약처 — 의료기기 회수", src_au:"TGA DRAC — 의료기기 회수",
