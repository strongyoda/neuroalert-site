...
const I18N = {
  en: {
    ...
    th_source:"Source", th_company:"Manufacturer", th_device:"Device", th_class:"Category", th_code:"Code", th_reason:"Reason", th_date:"Date",
    js_variant:"variants", js_event_note:"Adverse-event reports (not recalls)", js_detail_hint:"details", type_fda_alert:"FDA Alerts", js_fda_note:"FDA-curated serious recalls & early alerts", js_official:"Official response", js_similar:"Similar recalls (same event, other countries)", js_similar_more:"View full",
    badge_ea:"Early Alert · collecting info", badge_recall_confirmed:"Recall Confirmed",
    js_detail_close:"Close", cov_ea:"FDA Alerts: curated most-serious recalls & early alerts with images (CDRH).",
    reason_label:"Reason", purpose_label:"Indication", license_label:"License No.", code_label:"Code", affected_label:"Affected models / sizes",
    ev_device_problem:"Device problem", ev_patient_problem:"Patient problem", ev_narrative:"Event narrative (FDA MAUDE, original)", ev_mfr_narrative:"Manufacturer analysis (original)", ev_type_label:"Event type:", ev_report_label:"Report No.", ev_fda_link:"openFDA source data →", ev_reports:"reports", ev_report_n:"Report {n}", ev_loading:"Loading report narrative…", js_adv_loading:"loading adverse events in background…",
    src_jp:"PMDA — Device Recalls", cov_jp:"Device recalls with product, manufacturer, reason, and date (translated from Japanese).", src_de:"BfArM — Device Safety Notices", src_uk:"MHRA — Field Safety Notices", src_ch:"Swissmedic — FSCA / Recalls", src_fr:"ANSM — Safety Information", src_nl:"IGJ — Manufacturer FSCA Warnings", cov_de:"Manufacturer field safety notices (translated from German); reason from official PDF.", cov_uk:"Field safety notices with manufacturer, device, reason, and action (from FSN PDF).", cov_ch:"Field safety corrective actions with manufacturer, device, and date; reason extracted from official FSN PDF.", cov_fr:"Safety information (recalls, user information) with manufacturer, device, and date; reason extracted from official FSN PDF (translated from French).", cov_nl:"Manufacturer field safety corrective actions with device and date; reason taken from the notice text or FSN PDF.",
  ...
  ko: {
    ...
    th_source:"국가", th_company:"제조사", th_device:"기기명", th_class:"분류", th_code:"코드", th_reason:"사유", th_date:"날짜",
    js_variant:"변형", js_event_note:"이상사례 신고 (회수 아님)", js_detail_hint:"상세 보기", type_fda_alert:"FDA 경보", js_fda_note:"FDA가 선별한 중대 회수·조기경보", js_official:"공식 답변", js_similar:"유사 리콜 (동일 사건 · 타 국가)", js_similar_more:"전체 보기",
    badge_ea:"조기경보 · 정보수집중", badge_recall_confirmed:"회수 확정",
    js_detail_close:"접기", cov_ea:"FDA 경보: CDRH가 선별한 가장 중대한 회수·조기경보 (이미지 포함).",
    reason_label:"사유", purpose_label:"용도", license_label:"허가번호", code_label:"코드", affected_label:"리콜된 모델·사이즈",
    ev_device_problem:"기기 문제", ev_patient_problem:"환자 문제", ev_narrative:"사건 경위 (FDA MAUDE 원문)", ev_mfr_narrative:"제조사 분석 (원문)", ev_type_label:"사건 유형:", ev_report_label:"리포트번호", ev_fda_link:"openFDA 원본 데이터 →", ev_reports:"건 보고", ev_report_n:"보고 {n}", ev_loading:"원문 불러오는 중…", js_adv_loading:"이상사례 백그라운드 로딩 중…",
    src_jp:"PMDA — 의료기기 회수", cov_jp:"제품·제조사·사유·날짜 포함 (일본어에서 번역).", src_de:"BfArM — 의료기기 안전성 공지", src_uk:"MHRA — 현장 안전성 공지", src_ch:"Swissmedic — 안전성 시정조치/회수", src_fr:"ANSM — 안전성 정보", src_nl:"IGJ — 제조사 안전성 시정조치 경고", cov_de:"제조사 안전성 공지 (독일어에서 번역); 사유는 공식 PDF에서 추출.", cov_uk:"제조사·기기·사유·조치 포함 현장안전성 공지 (FSN PDF에서).", cov_ch:"제조사·기기·날짜 포함 안전성 시정조치(FSCA); 사유는 공식 FSN PDF에서 추출.", cov_fr:"제조사·기기·날짜 포함 안전성 정보(회수·사용자 안내); 사유는 공식 FSN PDF에서 추출(프랑스어에서 번역).", cov_nl:"기기·날짜 포함 제조사 안전성 시정조치; 사유는 공지 본문 또는 FSN PDF에서 추출.",
    sub_title:"이메일 알림",
