...
const I18N = {
  en: {
    ...
    hero_sub:"Consolidated recall and adverse-event signals for neurointerventional devices — drawn from the public post-market databases of eight regulators: U.S. FDA, Korea MFDS, Australia TGA, Health Canada, Japan PMDA, Germany BfArM, UK MHRA, and Swissmedic.",
  ...
  ko: {
    ...
    hero_sub:"신경중재 의료기기의 리콜·이상사례 신호를 미국 FDA, 한국 식약처(MFDS), 호주 TGA, 캐나다 보건부, 일본 PMDA, 독일 BfArM, 영국 MHRA, 스위스 Swissmedic — 8개 규제기관의 공개 사후감시 데이터에서 모아 한 화면에 보여줍니다.",
    ...
    src_jp:"PMDA — 의료기기 회수", cov_jp:"제품·제조사·사유·날짜 포함 (일본어에서 번역).", src_de:"BfArM — 의료기기 안전성 공지", src_uk:"MHRA — 현장 안전성 공지", src_ch:"Swissmedic — 안전성 시정조치/회수", cov_de:"제조사 안전성 공지 (독일어에서 번역); 사유는 공식 PDF에서 추출.", cov_uk:"제조사·기기·사유·조치 포함 현장안전성 공지 (FSN PDF에서).", cov_ch:"제조사·기기·날짜 포함 안전성 시정조치(FSCA); 사유는 공식 FSN PDF에서 추출.",
    sub_title:"이메일 알림",
