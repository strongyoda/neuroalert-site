...
const I18N = {
  en: {
    ...
    js_variant:"variants", js_event_note:"Adverse-event reports (not recalls)", js_detail_hint:"details", type_fda_alert:"FDA Alerts", js_fda_note:"FDA-curated serious recalls & early alerts", js_official:"Official response", js_similar:"Similar recalls (same event, other countries)",
  ...
  ko: {
    ...
    js_variant:"변형", js_event_note:"이상사례 신고 (회수 아님)", js_detail_hint:"상세 보기", type_fda_alert:"FDA 경보", js_fda_note:"FDA가 선별한 중대 회수·조기경보", js_official:"공식 답변", js_similar:"유사 리콜 (동일 사건 · 타 국가)",
